...
const DashboardI18n = {
    ...
    _core: {
        ...
        'attendance.resignationDesc': {
            ko: '당월 중 퇴사한 직원의 출근율은 <strong>출결 데이터의 실제 근무일 중 퇴사일까지의 일수</strong>를 총 근무일로 사용합니다. 퇴사 후 미출근일은 결근으로 처리하지 않습니다.',
            en: 'For employees who resign mid-month, the attendance rate uses <strong>actual working days from attendance data up to the resignation date</strong> as total working days. Days after resignation are not counted as absences.',
            vi: 'Đối với nhân viên nghỉ việc giữa tháng, tỷ lệ đi làm tính <strong>số ngày làm thực tế từ dữ liệu chấm công đến ngày nghỉ việc</strong> làm tổng ngày làm. Những ngày sau khi nghỉ việc không tính là vắng mặt.'
        },
        'attendance.resignationExample': {
            ko: '예: 3월 총 근무일 22일, 3/20 퇴사 → 퇴사일 포함 근무가능일 = 17일, 퇴사 후 5일은 결근 미처리',
            en: 'Example: March has 22 working days, resigned Mar 20 → Working days including resignation date = 17, 5 days after are not counted',
        ...
        'modal.attendanceFormula': { ko: '📊 출근율 계산', en: '📊 Attendance Calculation', vi: '📊 Tính tỷ lệ đi làm' },
        'modal.formulaAbsence': { ko: '결근일 = 총근무일 - 실근무일 - 승인휴가', en: 'Absence = Total - Actual - Leave', vi: 'Vắng = Tổng - Thực - Phép' },
        'modal.formulaRate': { ko: '출근율', en: 'Rate', vi: 'Tỷ lệ' },
        ...
        'admin.tabAllowances': { ko: '출결 Allowance', en: 'Attendance Allowance', vi: 'Allowance Tham Dự' },
        'admin.tabAqlAllowances': { ko: 'AQL Allowance', en: 'AQL Allowance', vi: 'AQL Allowance' },
        'admin.allowances.title': { ko: '출결 Allowance 관리 (예외 승인)', en: 'Attendance Allowance Management (Exception Override)', vi: 'Quản lý Allowance Tham Dự (Ghi đè ngoại lệ)' },
        ...
        'admin.allowances.recalcTitle': { ko: '출결 Allowance 인센티브 재계산', en: 'Attendance Allowance Incentive Recalculation', vi: 'Tính lại Incentive Allowance Tham Dự' },
        'admin.allowances.recalcDesc': { ko: 'Allowance 적용 후 인센티브 금액이 0인 직원을 재계산합니다.', en: 'Recalculate incentives for employees with 0 amount after allowance applied.', vi: 'Tính lại incentive cho nhân viên có số tiền 0 sau khi áp dụng allowance.' },
        'admin.allowances.recalcBtn': { ko: '인센티브 재계산', en: 'Recalculate Incentives', vi: 'Tính lại Incentive' },
        'admin.allowances.recalculating': { ko: '재계산 중...', en: 'Recalculating...', vi: 'Đang tính lại...' },
        'admin.allowances.loadingData': { ko: '데이터 로드 중...', en: 'Loading data...', vi: 'Đang tải dữ liệu...' },
        'admin.allowances.recalcNoTarget': { ko: '재계산 대상이 없습니다. 모든 Allowance 직원의 인센티브가 정상입니다.', en: 'No recalculation needed. All allowance employees have correct incentives.', vi: 'Không cần tính lại. Tất cả nhân viên allowance đều có incentive đúng.' },
        'admin.allowances.updatingFirestore': { ko: 'Firestore 업데이트 중...', en: 'Updating Firestore...', vi: 'Đang cập nhật Firestore...' },
        'admin.allowances.recalcComplete': { ko: '명 인센티브 재계산 완료', en: 'employee(s) incentive recalculation complete', vi: 'nhân viên đã tính lại incentive' },
        'admin.allowances.colEmpNo': { ko: '사번', en: 'Emp No', vi: 'Mã NV' },
        'admin.allowances.colName': { ko: '이름', en: 'Name', vi: 'Tên' },
        'admin.allowances.colContMonths': { ko: '연속개월', en: 'Cont. Months', vi: 'Tháng liên tục' },
        'admin.allowances.colIncentive': { ko: '인센티브', en: 'Incentive', vi: 'Incentive' },
        'admin.allowances.applying': { ko: 'Allowance 적용 중...', en: 'Applying Allowance...', vi: 'Đang áp dụng Allowance...' },
        'admin.allowances.stepCreateDoc': { ko: 'Allowance 문서 생성...', en: 'Creating allowance document...', vi: 'Đang tạo tài liệu allowance...' },
        'admin.allowances.stepUpdateEmployee': { ko: '직원 데이터 업데이트...', en: 'Updating employee data...', vi: 'Đang cập nhật dữ liệu nhân viên...' },
        'admin.allowances.stepFinalize': { ko: '완료 처리...', en: 'Finalizing...', vi: 'Đang hoàn tất...' },
        'admin.allowances.stepRecalcSummary': { ko: '대시보드 요약 재계산...', en: 'Recalculating dashboard summary...', vi: 'Đang tính lại tổng hợp bảng điều khiển...' },
        'admin.allowances.revoking': { ko: 'Allowance 철회 중...', en: 'Revoking Allowance...', vi: 'Đang thu hồi Allowance...' },
        'admin.allowances.stepQueryDoc': { ko: 'Allowance 문서 조회...', en: 'Querying allowance document...', vi: 'Đang truy vấn tài liệu allowance...' },
        'admin.allowances.stepRestoreData': { ko: '직원 데이터 복원...', en: 'Restoring employee data...', vi: 'Đang khôi phục dữ liệu nhân viên...' },
        'admin.allowances.stepUpdateStatus': { ko: '상태 업데이트...', en: 'Updating status...', vi: 'Đang cập nhật trạng thái...' },
        'admin.allowances.personSuffix': { ko: '명', en: ' employee(s)', vi: ' nhân viên' },

        // ─── AQL Reject PO Allowance ───────────────────────────────
        'admin.aqlAllowances.title': { ko: 'AQL Allowance 관리 (PO 기반 예외 승인)', en: 'AQL Allowance Management (PO-based Exception Override)', vi: 'Quản lý AQL Allowance (Ghi đè ngoại lệ theo PO)' },
        'admin.aqlAllowances.infoGuide': { ko: 'AQL 검사에서 reject된 PO를 등록하면, 시스템이 영향받는 직원의 c5~c8 조건을 자동 산출하여 면제 처리합니다. 원본 데이터는 보존됩니다.', en: 'Register AQL-rejected POs and the system will automatically identify affected employees and override c5~c8 conditions. Original data is preserved.', vi: 'Đăng ký các PO bị reject trong kiểm tra AQL và hệ thống sẽ tự động xác định các nhân viên bị ảnh hưởng và ghi đè điều kiện c5~c8. Dữ liệu gốc được bảo toàn.' },
        'admin.aqlAllowances.poInputLabel': { ko: 'PO 번호 (복수 입력 가능, Enter로 추가)', en: 'PO Numbers (multiple, press Enter to add)', vi: 'Số PO (nhiều, nhấn Enter để thêm)' },
        'admin.aqlAllowances.poInputPlaceholder': { ko: 'PO 번호 입력 후 Enter (예: 902219963)', en: 'Type PO number and Enter (e.g., 902219963)', vi: 'Nhập PO và nhấn Enter (vd: 902219963)' },
        'admin.aqlAllowances.rootCause': { ko: '근본 원인 (필수)', en: 'Root Cause (required)', vi: 'Nguyên nhân gốc (bắt buộc)' },
        'admin.aqlAllowances.rootCausePlaceholder': { ko: '예: 원자재 결함으로 인한 외관 불량', en: 'e.g., Surface defects caused by raw material issue', vi: 'vd: Khuyết tật do nguyên liệu thô' },
        'admin.aqlAllowances.actionPlan': { ko: '액션 플랜 (필수)', en: 'Action Plan (required)', vi: 'Kế hoạch hành động (bắt buộc)' },
        'admin.aqlAllowances.actionPlanPlaceholder': { ko: '예: 공급사 시정 요구 + 입고 검사 강화', en: 'e.g., Request supplier corrective action + strengthen incoming inspection', vi: 'vd: Yêu cầu nhà cung cấp khắc phục + tăng cường kiểm tra đầu vào' },
        'admin.aqlAllowances.actionDueDate': { ko: '액션 마감일 (필수)', en: 'Action Due Date (required)', vi: 'Ngày hoàn thành (bắt buộc)' },
        'admin.aqlAllowances.attachments': { ko: '첨부 파일 (사진/문서, 최대 3개)', en: 'Attachments (photos/documents, max 3)', vi: 'Tệp đính kèm (ảnh/tài liệu, tối đa 3)' },
        'admin.aqlAllowances.exemptConditions': { ko: '면제 조건 선택', en: 'Select Exempt Conditions', vi: 'Chọn điều kiện miễn' },
        'admin.aqlAllowances.exemptC5': { ko: 'C5: 개인 AQL FAIL', en: 'C5: AQL Personal Failure', vi: 'C5: AQL Cá nhân Fail' },
        'admin.aqlAllowances.exemptC6': { ko: 'C6: 연속 AQL FAIL', en: 'C6: AQL Consecutive', vi: 'C6: AQL Liên tiếp' },
        'admin.aqlAllowances.exemptC7': { ko: 'C7: 팀/구역 AQL', en: 'C7: AQL Team/Area', vi: 'C7: AQL Nhóm/Khu vực' },
        'admin.aqlAllowances.exemptC8': { ko: 'C8: 구역 Reject율', en: 'C8: Area Reject Rate', vi: 'C8: Tỷ lệ Reject Khu vực' },
        'admin.aqlAllowances.computeImpact': { ko: '영향 직원 미리보기', en: 'Preview Affected Employees', vi: 'Xem trước nhân viên bị ảnh hưởng' },
        'admin.aqlAllowances.apply': { ko: 'AQL Allowance 적용', en: 'Apply AQL Allowance', vi: 'Áp dụng AQL Allowance' },
        'admin.aqlAllowances.computing': { ko: '영향 직원 산출 중...', en: 'Computing affected employees...', vi: 'Đang tính toán nhân viên bị ảnh hưởng...' },
        'admin.aqlAllowances.applying': { ko: 'AQL Allowance 적용 중...', en: 'Applying AQL Allowance...', vi: 'Đang áp dụng AQL Allowance...' },
        'admin.aqlAllowances.applied': { ko: 'AQL Allowance 적용 완료', en: 'AQL Allowance applied successfully', vi: 'Đã áp dụng AQL Allowance thành công' },
        'admin.aqlAllowances.revoke': { ko: '철회', en: 'Revoke', vi: 'Thu hồi' },
        'admin.aqlAllowances.revoked': { ko: 'AQL Allowance 철회 완료', en: 'AQL Allowance revoked successfully', vi: 'Đã thu hồi AQL Allowance thành công' },
        'admin.aqlAllowances.confirmApply': { ko: '이 AQL Allowance를 적용하시겠습니까? 영향 직원의 인센티브가 자동으로 재계산됩니다.', en: 'Apply this AQL Allowance? Affected employees\' incentives will be recalculated.', vi: 'Áp dụng AQL Allowance này? Incentive của nhân viên bị ảnh hưởng sẽ được tính lại.' },
        'admin.aqlAllowances.confirmRevoke': { ko: 'AQL Allowance를 철회하시겠습니까? 영향 직원의 원본 값으로 복원됩니다.', en: 'Revoke this AQL Allowance? Affected employees\' original values will be restored.', vi: 'Thu hồi AQL Allowance này? Giá trị gốc của nhân viên bị ảnh hưởng sẽ được khôi phục.' },
        'admin.aqlAllowances.activeList': { ko: '등록된 AQL Allowance 목록', en: 'Registered AQL Allowances', vi: 'Danh sách AQL Allowance đã đăng ký' },
        'admin.aqlAllowances.noActive': { ko: '이 월에 등록된 AQL Allowance가 없습니다.', en: 'No AQL Allowances registered for this month.', vi: 'Không có AQL Allowance nào cho tháng này.' },
        'admin.aqlAllowances.noPoEntered': { ko: 'PO 번호를 1개 이상 입력하세요.', en: 'Please enter at least one PO number.', vi: 'Vui lòng nhập ít nhất một số PO.' },
        'admin.aqlAllowances.noConditionSelected': { ko: '면제 조건을 1개 이상 선택하세요.', en: 'Please select at least one exempt condition.', vi: 'Vui lòng chọn ít nhất một điều kiện miễn.' },
        'admin.aqlAllowances.rootCauseRequired': { ko: '근본 원인을 입력하세요.', en: 'Please enter root cause.', vi: 'Vui lòng nhập nguyên nhân gốc.' },
        'admin.aqlAllowances.actionPlanRequired': { ko: '액션 플랜을 입력하세요.', en: 'Please enter action plan.', vi: 'Vui lòng nhập kế hoạch hành động.' },
        'admin.aqlAllowances.actionDueDateRequired': { ko: '액션 마감일을 선택하세요.', en: 'Please select action due date.', vi: 'Vui lòng chọn ngày hoàn thành.' },
        'admin.aqlAllowances.matchedRows': { ko: '매칭된 AQL 행', en: 'Matched AQL Rows', vi: 'Số dòng AQL khớp' },
        'admin.aqlAllowances.matchedFails': { ko: 'FAIL 건수', en: 'FAIL Count', vi: 'Số lần FAIL' },
        'admin.aqlAllowances.totalRejectQty': { ko: 'Reject 수량 합계', en: 'Total Reject Qty', vi: 'Tổng số lượng Reject' },
        'admin.aqlAllowances.affectedCount': { ko: '영향 받는 직원 수', en: 'Affected Employees', vi: 'Số nhân viên bị ảnh hưởng' },
        'admin.aqlAllowances.noAffected': { ko: '면제 적용으로 인센티브 변동이 발생하는 직원이 없습니다.', en: 'No employees would have incentive changes from this exemption.', vi: 'Không có nhân viên nào có thay đổi incentive từ miễn này.' },
        'admin.aqlAllowances.noPoMatch': { ko: '입력한 PO 번호와 일치하는 AQL 행이 없습니다.', en: 'No AQL rows match the entered PO numbers.', vi: 'Không có dòng AQL nào khớp với các số PO đã nhập.' },
        'admin.aqlAllowances.colEmpNo': { ko: '사번', en: 'Emp No', vi: 'Mã NV' },
        'admin.aqlAllowances.colName': { ko: '이름', en: 'Name', vi: 'Tên' },
        'admin.aqlAllowances.colPosition': { ko: '직급', en: 'Position', vi: 'Chức vụ' },
        'admin.aqlAllowances.colBefore': { ko: 'Before', en: 'Before', vi: 'Trước' },
        'admin.aqlAllowances.colAfter': { ko: 'After', en: 'After', vi: 'Sau' },
        'admin.aqlAllowances.colPassRate': { ko: 'Pass Rate', en: 'Pass Rate', vi: 'Tỷ lệ Pass' },
        'admin.aqlAllowances.colIncentive': { ko: '인센티브', en: 'Incentive', vi: 'Incentive' },
        'admin.aqlAllowances.colPoNumbers': { ko: 'PO 번호', en: 'PO Numbers', vi: 'Số PO' },
        'admin.aqlAllowances.colRootCause': { ko: '근본 원인', en: 'Root Cause', vi: 'Nguyên nhân' },
        'admin.aqlAllowances.colActionPlan': { ko: '액션 플랜', en: 'Action Plan', vi: 'Kế hoạch hành động' },
        'admin.aqlAllowances.colActionStatus': { ko: '상태', en: 'Status', vi: 'Trạng thái' },
        'admin.aqlAllowances.colDueDate': { ko: '마감일', en: 'Due Date', vi: 'Ngày hoàn thành' },
        'admin.aqlAllowances.colAffected': { ko: '영향 직원', en: 'Affected', vi: 'Bị ảnh hưởng' },
        'admin.aqlAllowances.colAppliedBy': { ko: '적용자', en: 'Applied By', vi: 'Người áp dụng' },
        'admin.aqlAllowances.colActions': { ko: '동작', en: 'Actions', vi: 'Hành động' },
        'admin.aqlAllowances.actionStatus.PLANNED': { ko: '계획', en: 'Planned', vi: 'Đã lên kế hoạch' },
        'admin.aqlAllowances.actionStatus.IN_PROGRESS': { ko: '진행중', en: 'In Progress', vi: 'Đang tiến hành' },
        'admin.aqlAllowances.actionStatus.COMPLETED': { ko: '완료', en: 'Completed', vi: 'Hoàn thành' },
        'admin.aqlAllowances.summary': { ko: '자동 산출 정보', en: 'Auto-Computed Info', vi: 'Thông tin tự động' },
        'admin.aqlAllowances.affectedTitle': { ko: '영향 직원 미리보기', en: 'Affected Employees Preview', vi: 'Xem trước nhân viên bị ảnh hưởng' },
